...
public class TinkersArrowEntityOld extends ProjectileEntity implements IEntityAdditionalSpawnData, ICriticalProjectile, IDamageProjectile, IPiercingProjectile, IWaterInertiaProjectile, IWeightProjectile, ITrajectoryProjectile {
    ...
    public TinkersArrowEntityOld(EntityType<? extends TinkersArrowEntityOld> entityType, World world) {
    ...
    public TinkersArrowEntityOld(double xPos, double yPos, double zPos, World world) {
        this(TinkersArchery.TINKERS_ARROW_OLD.get(), world);
        this.setPos(xPos, yPos, zPos);
    }

    public TinkersArrowEntityOld(World world, LivingEntity shooter, StatsNBT stats) {
