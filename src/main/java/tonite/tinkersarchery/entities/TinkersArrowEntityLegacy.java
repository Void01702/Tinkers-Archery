...
public class TinkersArrowEntityLegacy extends ProjectileEntity implements IEntityAdditionalSpawnData, ICriticalProjectile, IDamageProjectile, IPiercingProjectile, IWaterInertiaProjectile, IWeightProjectile, ITrajectoryProjectile {
    ...
    private float waterInertia = 0.2f;
    ...
    public TinkersArrowEntityLegacy(EntityType<? extends TinkersArrowEntityLegacy> entityType, World world) {
    ...
    public TinkersArrowEntityLegacy(double xPos, double yPos, double zPos, World world) {
        this(TinkersArchery.TINKERS_ARROW_LEGACY.get(), world);
        this.setPos(xPos, yPos, zPos);
    }

    public TinkersArrowEntityLegacy(World world, LivingEntity shooter, StatsNBT stats) {
    ...
    public void addAdditionalSaveData(CompoundNBT nbt) {
        ...
        nbt.putFloat("WeightBonus", weightBonus);
        nbt.putFloat("StabilityBonus", stabilityBonus);
    ...
    private Vector3d getArrowMotion() {
        ...
        try {
            return trajectory.getMotionDirection(numTicks, originalDirection, weight, stability, 1.0f, trajectoryData);
        } catch (Exception e) {
