...
@OnlyIn(Dist.CLIENT)
public class TinkersArrowRenderer extends EntityRenderer<TinkersArrowEntity> {
    ...
    public TinkersArrowRenderer(EntityRendererManager p_i46193_1_, ResourceLocation... textureLocations) {
        super(p_i46193_1_);
        this.textureLocations = textureLocations;
    }

    @Override
    public ResourceLocation getTextureLocation(TinkersArrowEntity p_110775_1_) {
    ...
    @Override
    public void render(TinkersArrowEntity arrow, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
    ...
    public void renderPart(int partIndex, TinkersArrowEntity arrow, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
    ...
    public void renderPartless(TinkersArrowEntity arrow, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
