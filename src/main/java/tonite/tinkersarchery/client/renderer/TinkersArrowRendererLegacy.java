...
@OnlyIn(Dist.CLIENT)
public class TinkersArrowRendererLegacy extends EntityRenderer<TinkersArrowEntityLegacy> {
    ...
    public TinkersArrowRendererLegacy(EntityRendererManager p_i46193_1_, ResourceLocation... textureLocations) {
        super(p_i46193_1_);
        this.textureLocations = textureLocations;
    }

    @Override
    public ResourceLocation getTextureLocation(TinkersArrowEntityLegacy p_110775_1_) {
        return NORMAL_ARROW_LOCATION;
    }

    public TextureInformation getTextureLocation(TinkersArrowEntityLegacy entity, int partIndex) {
    ...
    @Override
    public void render(TinkersArrowEntityLegacy arrow, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
    ...
    public void renderPart(int partIndex, TinkersArrowEntityLegacy arrow, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
    ...
    public void renderPartless(TinkersArrowEntityLegacy arrow, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
