...
public class ContentBowHeadMaterial extends ContentMaterial {

    public static final String ID = "bowtoolheadmaterial";

    public ContentBowHeadMaterial(IMaterial material) {
        super(material, true);
    }
    ...
    public void build(BookData book, ArrayList<BookElement> list, boolean rightSide) {
        ...
        // bowshaft stats
        int bowshaftTraits = this.addStatsDisplay(x, y, w, list, material, BowMaterialStats.ID);
        // handle
        int bowguideTraits = this.addStatsDisplay(x + w, y, w - left, list, material, BowGuideMaterialStats.ID);
    ...
    private static IMaterial getFirstMaterialWithType(MaterialStatsId statsId, boolean isBowString) {
        ...
        if (hasStatType(MaterialRegistry.getMaterial(MaterialIds.wood).getIdentifier(), statsId)) {
            return MaterialRegistry.getMaterial(MaterialIds.wood);
        }
