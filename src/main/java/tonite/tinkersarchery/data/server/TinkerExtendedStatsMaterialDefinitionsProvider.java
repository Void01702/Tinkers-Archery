    ...
    public static class TinkerExtendedStatsMaterialStatsDataProvider extends AbstractMaterialStatsDataProvider {
        ...
        protected void addMaterialStats() {
            ...
            addMaterialStats(MaterialIds.wood,
                    ...
                    new ArrowHeadMaterialStats(3, 2f, WOOD, 0f, 0.8f, 0.8f 0.9f),
                    new ArrowShaftMaterialStats(1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f));

            addMaterialStats(MaterialIds.stone,
                    //new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.0f, 1.0f),
                    new ArrowHeadMaterialStats(4, 4f, STONE, 1f, 1.3f, 1.3f, 0.8f),
            ...
            addMaterialStats(MaterialIds.flint,
                    ...
                    new ArrowHeadMaterialStats(8, 3.5f, STONE, 1.25f, 1.0f, 1.0f, 1.0f),
            ...
            addMaterialStats(MaterialIds.iron,
                    ...
                    new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.0f, 1.0f),
                    new ArrowHeadMaterialStats(13, 6f, IRON, 2f, 1.3f, 1.3f, 1.0f),
                    new ArrowShaftMaterialStats(1.1f, 1.0f, 1.0f, 1.0f, 1.2f, 1.0f));

            addMaterialStats(MaterialIds.copper,
                    new BowMaterialStats(210, 3.25f, 1.05f),
                    new BowGuideMaterialStats(),//new BowGuideMaterialStats(0.9f, 1.1f),
                    new ArrowHeadMaterialStats(10, 6.5f, IRON, 1.5f, 1f, 1f, 1.3f),
                    new ArrowShaftMaterialStats(0.85f, 1.2f, 1.0f, 1.0f, 1.1f, 1.3f));

            addMaterialStats(MaterialIds.searedStone,
                    //new BowGuideMaterialStats(),//new BowGuideMaterialStats(0.9f, 1.1f),
                    new ArrowHeadMaterialStats(9, 5f, IRON, 2.25f, 1.25f, 1.25f, 1.1f),
            ...
            addMaterialStats(MaterialIds.scorchedStone,
                    ...
                    new ArrowHeadMaterialStats(10, 4.5f, IRON, 2.5f, 1.25f, 1.25f, 0.9f),
            ...
            addMaterialStats(MaterialIds.slimewood,
                    ...
                    new ArrowHeadMaterialStats(6, 4f, IRON, 1f, 0.75f, 0.75f, 0.7f),
            ...
            addMaterialStats(MaterialIds.osmium,
                    ...
                    new ArrowHeadMaterialStats(13, 4.5f, IRON, 2.0f, 1.6f, 1.6f, 0.8f),
            ...
            addMaterialStats(MaterialIds.tungsten,
                    ...
                    new ArrowHeadMaterialStats(14, 6.5f, IRON, 1.75f, 1.55f, 1.55f, 1.0f),
            ...
            addMaterialStats(MaterialIds.platinum,
                    ...
                    new ArrowHeadMaterialStats(16, 7.0f, IRON, 1.5f, 1.4f, 1.4f, 1.1f),
            ...
            addMaterialStats(MaterialIds.silver,
                    ...
                    new ArrowHeadMaterialStats(13, 5.5f, IRON, 2.25f, 1.35f, 1.35f, 1.2f),
            ...
            addMaterialStats(MaterialIds.lead,
                    ...
                    new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.1f, 1.0f),
                    new ArrowHeadMaterialStats(5, 5f, IRON, 2.5f, 1.5f, 1.5f, 1.1f),
            ...
            addMaterialStats(MaterialIds.whitestone,
                    ...
                    new ArrowHeadMaterialStats(12, 6.0f, IRON, 1.25f, 1.35f, 1.35f, 0.85f),
            ...
            addMaterialStats(MaterialIds.pigIron,
                    new BowMaterialStats(580, 4f, 1f),
                    new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.1f, 1.1f),
                    new ArrowHeadMaterialStats(20, 6f, DIAMOND, 2.5f, 1.35f, 1.35f, 1.2f),
            ...
            addMaterialStats(MaterialIds.roseGold,
                    ...
                    new BowGuideMaterialStats(),//new BowGuideMaterialStats(0.9f, 1.2f),
                    new ArrowHeadMaterialStats(12, 10f, IRON, 1f, 0.8f, 0.8f, 1.5f),
            ...
            addMaterialStats(MaterialIds.cobalt,
                    ...
                    new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.0f, 1.1f),
                    new ArrowHeadMaterialStats(19, 7.5f, DIAMOND, 2.25f, 0.9f, 0.9f, 1.0f),
            ...
            addMaterialStats(MaterialIds.steel,
                    ...
                    new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.0f, 1.2f),
                    new ArrowHeadMaterialStats(21, 6f, DIAMOND, 2.75f, 1.4f, 1.4f, 1.1f),
                    new ArrowShaftMaterialStats(1.05f, 1.05f, 1.05f, 1.0f, 1.3f, 1.1f));

            addMaterialStats(MaterialIds.bronze,
                    new BowMaterialStats(760, 3.75f, 1.05f),
                    new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.0f, 1.2f),
                    new ArrowHeadMaterialStats(18, 7f, DIAMOND, 2f, 0.95f, 0.95f, 1.25f),
                    new ArrowShaftMaterialStats(1.1f, 1.05f, 1.0f, 1.0f, 1.05f, 1.25f));

            addMaterialStats(MaterialIds.constantan,
                    new BowMaterialStats(675, 4f, 1f),
                    new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.0f, 1.2f),
                    new ArrowHeadMaterialStats(20, 7.5f, DIAMOND, 1.75f, 0.9f, 0.9f, 1.15f),
            ...
            addMaterialStats(MaterialIds.invar,
                    ...
                    new ArrowHeadMaterialStats(21, 5.5f, DIAMOND, 2.5f, 1.4f, 1.4f, 0.9f),
            ...
            addMaterialStats(MaterialIds.electrum,
                    ...
                    new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.1f, 1.0f),
                    new ArrowHeadMaterialStats(17, 9f, IRON, 1.5f, 1.15f, 1.15f, 0.9f),
            ...
            addMaterialStats(MaterialIds.platedSlimewood,
                    ...
                    new ArrowHeadMaterialStats(27, 5.0f, DIAMOND, 2.0f, 0.85f, 0.85f, 0.8f),
            ...
            addMaterialStats(MaterialIds.queensSlime,
                    ...
                    new ArrowHeadMaterialStats(32, 6f, NETHERITE, 2f, 0.9f, 0.9f, 0.65f),
            ...
            addMaterialStats(MaterialIds.hepatizon,
                    ...
                    new ArrowHeadMaterialStats(28, 8f, NETHERITE, 2.5f, 0.8f, 0.8f, 1.0f),
            ...
            addMaterialStats(MaterialIds.manyullyn,
                    ...
                    new ArrowHeadMaterialStats(30, 6.5f, NETHERITE, 3.5f, 1.25f, 1.25f, 0.7f),
