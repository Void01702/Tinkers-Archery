    ...
    public static class TinkerExtendedStatsMaterialStatsDataProvider extends AbstractMaterialStatsDataProvider {
        ...
        protected void addMaterialStats() {
            ...
            addMaterialStats(MaterialIds.wood,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f)); //count, rand*2, atk, weigh, stability, accuracy

            addMaterialStats(MaterialIds.stone,
                    //new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.0f, 1.0f),
                    new ArrowHeadMaterialStats(10, 4f, STONE, 0.75f, 1.05f, 1.1f, 1.0f),
                    new ArrowShaftMaterialStats(1.0f, 1.0f, 1.0f, 1.1f, 1.2f, 0.9f));
            ...
            addMaterialStats(MaterialIds.flint,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.1f, 1.0f, 1.0f, 1.1f, 0.7f));
            ...
            addMaterialStats(MaterialIds.iron,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.0f, 1.0f, 1.0f, 1.2f, 1.0f));
            ...
            addMaterialStats(MaterialIds.copper,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.2f, 1.0f, 1.0f, 1.1f, 1.3f));

            addMaterialStats(MaterialIds.searedStone,
                    //new BowGuideMaterialStats(),//new BowGuideMaterialStats(0.9f, 1.1f),
                    new ArrowHeadMaterialStats(12, 5f, IRON, 1.75f, 1f, 1f, 0.9f),
                    new ArrowShaftMaterialStats(1.0f, 1.0f, 1.0f, 1.15f, 1.1f, 1.1f));
            ...
            addMaterialStats(MaterialIds.scorchedStone,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.0f, 1.05f, 1.1f, 1.1f, 0.9f));
            ...
            addMaterialStats(MaterialIds.slimewood,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 0.85f, 1.0f, 0.85f, 0.9f, 0.8f));
            ...
            addMaterialStats(MaterialIds.bloodbone,
                    ...
                    new ArrowHeadMaterialStats(12, 4.5f, IRON, 1.75f, 0.95f, 1.1f, 0.9f),
            ...
            addMaterialStats(MaterialIds.osmium,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 0.9f, 0.9f, 1.0f, 1.7f, 0.8f));
            ...
            addMaterialStats(MaterialIds.tungsten,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.1f, 0.9f, 1.1f, 1.6f, 1.0f));
            ...
            addMaterialStats(MaterialIds.platinum,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.05f, 0.95f, 1.0f, 1.5f, 0.9f));
            ...
            addMaterialStats(MaterialIds.silver,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.05f, 1.1f, 1.0f, 1.15f, 1.1f));
            ...
            addMaterialStats(MaterialIds.whitestone,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.1f, 0.9f, 1.0f, 1.3f, 0.95f));
            ...
            addMaterialStats(MaterialIds.slimesteel,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.0f, 0.95f, 1.0f, 0.9f, 0.9f));
            ...
            addMaterialStats(MaterialIds.tinkersBronze,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.05f, 1.0f, 1.0f, 1.1f, 1.0f));
            ...
            addMaterialStats(MaterialIds.pigIron,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 0.85f, 1.0f, 1.1f, 1.3f, 1.1f));
            ...
            addMaterialStats(MaterialIds.roseGold,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.25f, 1.25f, 1.0f, 0.7f, 1.6f));
            ...
            addMaterialStats(MaterialIds.cobalt,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.05f, 1.05f, 1.1f, 0.85f, 1.0f));
            ...
            addMaterialStats(MaterialIds.steel,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.05f, 1.05f, 1.0f, 1.3f, 1.1f));

            addMaterialStats(MaterialIds.bronze,
                    new BowMaterialStats(760, 4f, 1f),
                    new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.0f, 1.2f),
                    new ArrowHeadMaterialStats(20, 7f, DIAMOND, 1.75f, 1.1f, 1.15f, 1.05f)),
                    new ArrowShaftMaterialStats(1.0f, 1.05f, 1.0f, 1.0f, 1.05f, 1.25f));

            addMaterialStats(MaterialIds.constantan,
                    new BowMaterialStats(675, 3.75f, 1f),
                    new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.0f, 1.2f),
                    new ArrowHeadMaterialStats(30, 7.5f, DIAMOND, 1.75f, 1.1f, 1.15f, 1.0f),
                    new ArrowShaftMaterialStats(1.0f, 1.15f, 1.0f, 1.0f, 1.0f, 1.05f));
            ...
            addMaterialStats(MaterialIds.invar,
                    ...
                    new ArrowHeadMaterialStats(25, 5.5f, DIAMOND, 2.0f, 1.1f, 1.15f, 1.0f),
            ...
            addMaterialStats(MaterialIds.necronium,
                    ...
                    //new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.0f, 1.2f),
                    new ArrowHeadMaterialStats(15, 4.0f, DIAMOND, 2.25f, 0.85f, 1.2f, 0.95f),
            ...
            addMaterialStats(MaterialIds.electrum,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.15f, 1.15f, 1.0f, 1.2f, 0.9f));
            ...
            addMaterialStats(MaterialIds.platedSlimewood,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 0.9f, 0.9f, 1.05f, 0.95f, 0.85f));
            ...
            addMaterialStats(MaterialIds.queensSlime,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 0.9f, 0.95f, 0.95f,1.0f, 0.8f));
            ...
            addMaterialStats(MaterialIds.hepatizon,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 1.2f, 1.0f, 0.9f, 0.95f, 0.9f));
            ...
            addMaterialStats(MaterialIds.manyullyn,
                    ...
                    new ArrowShaftMaterialStats(1.0f, 0.9f, 0.95f, 1.25f, 1.2f, 0.8f));

            addMaterialStats(MaterialIds.blazingBone,
                    //new BowMaterialStats(530, 4.5f, 1f),
                    //new BowGuideMaterialStats(),//new BowGuideMaterialStats(1.1f, 1.2f),
                    new ArrowHeadMaterialStats(24, 6f, IRON, 2.75f, 0.8f, 1.3f, 1.05f),
